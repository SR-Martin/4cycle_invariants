...
for i from 0 to #G1-1 do if G1_i == 0 then Gm#i = 0;
...
for i from 0 to #G2-1 do if G2_i == 0 then Gm#i = 0;
...
for i from 0 to #G3-1 do if G3_i == 0 then Gm#i = 0;
...
for i from 0 to #G4-1 do if G4_i == 0 then Gm#i = 0;
...
for i from 0 to #G5-1 do if G5_i == 0 then Gm#i = 0;
...
for i from 0 to #G6-1 do if G6_i == 0 then Gm#i = 0;
...
for i from 0 to #G7-1 do if G7_i == 0 then Gm#i = 0;
...
for i from 0 to #G8-1 do if G8_i == 0 then Gm#i = 0;
...
for i from 0 to #G9-1 do if G9_i == 0 then Gm#i = 0;
...
for i from 0 to #G10-1 do if G10_i == 0 then Gm#i = 0;
...
for i from 0 to #G11-1 do if G11_i == 0 then Gm#i = 0;

phyInv = toList(Gm)
"4LeafJC_GB_phylogenetic_new.txt" << toString(phyInv) << close;
quit;
